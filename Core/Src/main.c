...
static void MX_DMA_Init(void)
{
  ...
  hdma_memtomem_dma1_channel5.Init.PeriphDataAlignment = DMA_PDATAALIGN_HALFWORD;
  hdma_memtomem_dma1_channel5.Init.MemDataAlignment = DMA_MDATAALIGN_HALFWORD;
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(NCD15_GPIO_Port, NCD15_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : NC_Pin NCE3_Pin NCE4_Pin NCE5_Pin
                           NCE6_Pin NCE0_Pin NCE1_Pin */
  GPIO_InitStruct.Pin = NC_Pin|NCE3_Pin|NCE4_Pin|NCE5_Pin
                          |NCE6_Pin|NCE0_Pin|NCE1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);

  /*Configure GPIO pins : NCF9_Pin NCF10_Pin NCF2_Pin */
  GPIO_InitStruct.Pin = NCF9_Pin|NCF10_Pin|NCF2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pins : NCB11_Pin NCB12_Pin NCB13_Pin NCB14_Pin
                           NCB15_Pin */
  GPIO_InitStruct.Pin = NCB11_Pin|NCB12_Pin|NCB13_Pin|NCB14_Pin
                          |NCB15_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : NCD8_Pin NCD9_Pin NCD10_Pin NCD11_Pin
                           NCD12_Pin NCD13_Pin NCD14_Pin NCD0_Pin
                           NCD1_Pin NCD3_Pin NCD4_Pin NCD5_Pin
                           NCD6_Pin NCD7_Pin */
  GPIO_InitStruct.Pin = NCD8_Pin|NCD9_Pin|NCD10_Pin|NCD11_Pin
                          |NCD12_Pin|NCD13_Pin|NCD14_Pin|NCD0_Pin
                          |NCD1_Pin|NCD3_Pin|NCD4_Pin|NCD5_Pin
                          |NCD6_Pin|NCD7_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  ...
  /*Configure GPIO pin : NCD15_Pin */
  GPIO_InitStruct.Pin = NCD15_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(NCD15_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : NCC6_Pin NCC7_Pin NCC10_Pin NCC11_Pin
                           NCC12_Pin */
  GPIO_InitStruct.Pin = NCC6_Pin|NCC7_Pin|NCC10_Pin|NCC11_Pin
                          |NCC12_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
